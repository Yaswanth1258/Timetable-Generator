                        ...
                        <form onSubmit={handleSaveOverride} className="p-6 space-y-4">
                            ...
                            {!enableLiveUpdates && (
                                <div className="bg-amber-50 border border-amber-200 p-3 rounded-lg flex items-start gap-2 mt-4">
                                    ...
                                    <p className="text-xs text-amber-800">Manual overrides bypass the greedy algorithm constraints (like max load or lab-specific rooms). Ensure changes are valid.</p>
                                </div>
                            )}
